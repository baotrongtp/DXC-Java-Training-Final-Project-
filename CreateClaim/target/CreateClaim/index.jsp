...
<%
	String s=request.getParameter("policyNo");
	if(s==null || s.trim().equals("")){
	out.print("Enter Policy No");
	}else{
		out.print(s);
	try{
	Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
	Connection con=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databasename=Final_Project_DXC; user=sa;password=mysql");
	PreparedStatement ps=con.prepareStatement("select * from Moto_Policy where Policy_No=?");
	ps.setString(1,s);
